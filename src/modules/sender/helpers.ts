...
export const createAliyunEmailConfig: (
    register: ConfigureRegister<Partial<AliyunEmailConfig>>,
) => ConfigureFactory<Partial<AliyunEmailConfig>, AliyunEmailConfig> = (register) => ({
    register,
    defaultRegister: (configure) => ({
        ...
        fromAddress: configure.env('ALIYUN_EMAIL_FROM_ADDRESS', 'your-email@example.com'),
