...
export const getUserQueue = async (configure: Configure) => {
    ...
    if (configure.has('sms') && enables && enables.find((e) => smsNeed.includes(e))) enableSms = true;
    if (configure.has('smtp') && enables && enables.find((e) => emailNeed.includes(e))) enableEmail = true;
